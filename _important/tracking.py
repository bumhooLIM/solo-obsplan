...
parser.add_argument("-t", "--tracking", dest="command", action="store")
...
if args.command == "on":
    try:
        T.Tracking = True
        log.write(local_time+"Tracking On\n")
        print(local_time+"Tracking On")
    except Exception as e:
        log.write(local_time+"FAIL : Tracking On\n")
        log.write(local_time+"Error : "+str(e)+"\n")
        print(local_time+"FAIL : Tracking On")
elif args.command == "off":
    try:
        T.Tracking = False
        log.write(local_time+"Tracking Off\n")
        print(local_time+"Tracking Off")
    except Exception as e:
        log.write(local_time+"FAIL : Tracking Off\n")
        log.write(local_time+"Error : "+str(e)+"\n")
        print(local_time+"FAIL : Tracking Off")
else:
    log.write(local_time+"Wrong command("+args.command+").\n")
    print(local_time+"Wrong command("+args.command+").")
