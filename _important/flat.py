...
t_name = info[1].replace("[Telescope]: ", "")
...
try:
    ...
    log.write(local_time+f"Flat {exptime:.1f}s*{iterations:03d}\n")
    print(local_time+f"Flat {exptime:.1f}s*{iterations:03d}")
except Exception as e:
    log.write(local_time+f"FAIL : Flat {exptime:.1f}s*{iterations:03d}\n")
    log.write(local_time+f"Error : "+e+"\n")
    print(local_time+f"FAIL : Flat {exptime:.1f}s*{iterations:03d}")
    print(e)
