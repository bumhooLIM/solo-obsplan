...
try:
    ...
    log.write(local_time+f"Dark {exptime:.1f}s*{iterations:03d}\n")
    print(local_time+f"Dark {exptime:.1f}s*{iterations:03d}")
except Exception as e:
    log.write(local_time+f"FAIL : Dark {exptime:.1f}s*{iterations:03d}\n")
    log.write(local_time+f"Error : "+str(e)+"\n")
    print(local_time+f"FAIL : Dark {exptime:.1f}s*{iterations:03d}")
    print(e)
